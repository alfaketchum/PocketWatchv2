...
export const MERCHANT_MAP: Record<string, CategoryResult> = {
  ...
  "RITE AID": { category: "Healthcare", subcategory: "Pharmacy" },
  "PLANET FITNESS": { category: "Fitness", subcategory: "Gym" },
  "EQUINOX": { category: "Fitness", subcategory: "Gym" },
  "ORANGETHEORY": { category: "Fitness", subcategory: "Gym" },
  // Bills
  ...
  "NUMERO ESIM": { category: "Phone & Data", subcategory: "eSIM" },
  "AIRALO": { category: "Phone & Data", subcategory: "eSIM" },
  ...
  "CHATGPT": { category: "Software", subcategory: "Software" },
  "OPENAI": { category: "Software", subcategory: "Software" },
  "GITHUB": { category: "Software", subcategory: "Software" },
  "NOTION": { category: "Software", subcategory: "Software" },
  "SLACK": { category: "Software", subcategory: "Software" },
  "ZOOM": { category: "Software", subcategory: "Software" },
  "DROPBOX": { category: "Software", subcategory: "Software" },
  "GOOGLE STORAGE": { category: "Software", subcategory: "Software" },
  "ICLOUD": { category: "Bills & Utilities", subcategory: "Internet" },
  "ADOBE": { category: "Software", subcategory: "Software" },
  "SUBSTACK": { category: "Education", subcategory: "Substack" },
  "SHRUBSTACK": { category: "Education", subcategory: "Substack" },
  "CITRINI": { category: "Education", subcategory: "Substack" },
  "CLOUDFLARE": { category: "Software", subcategory: "Software" },
  "ANTHROPIC": { category: "Software", subcategory: "Software" },
  "BITQUERY": { category: "Software", subcategory: "Software" },
  "POSTIZ": { category: "Software", subcategory: "Software" },
  // Transfers
