...
export const FINANCE_CATEGORIES: Record<string, CategoryMeta> = {
  ...
  "Phone & Data": {
    label: "Phone & Data", icon: "smartphone", color: "lime",
    bgClass: "bg-lime-600/10", textClass: "text-lime-600",
    dotClass: "bg-lime-600", borderClass: "border-lime-600",
    hex: "#65a30d",
  },
  "Entertainment": {
  ...
  "Software": {
    label: "Software", icon: "code", color: "slate",
  ...
  "ATM/Cash": {
    label: "ATM/Cash", icon: "local_atm", color: "amber",
...
export const CATEGORY_GROUPS: CategoryGroup[] = [
  { label: "Income", icon: "payments", categories: ["Income"] },
  {
    ...
    categories: [
      ...
      "Personal Care", "Education", "Travel", "Software",
